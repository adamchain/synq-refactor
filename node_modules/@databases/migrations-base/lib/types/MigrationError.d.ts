...
declare type MigrationError = DatabaseVersionError | DatabaseUsesNewerVersionError | DatabaseUsesOlderVersionError | MigrationFilenamesError | MigrationWithNoValidExport | ConcurrentMigrationsError | DuplicateMigrationFilesError | MigrationFileMissingError | MigrationFileEditedError | MigrationOrderChangeError | MissingMigrationError | MissingParameterError;
